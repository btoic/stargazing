...
def build_pdf(output_dir=None):
    ...
    cat_data = [
        [Paragraph("#", table_header_style), Paragraph("Target Name", table_header_style), Paragraph("Const", table_header_style), Paragraph("Type", table_header_style), Paragraph("Mag", table_header_style), Paragraph("Size", table_header_style), Paragraph("Alt / Az @ 21:15", table_header_style), Paragraph("Eyepiece", table_header_style), Paragraph("Chart Ref", table_header_style)],
        [Paragraph("1", table_cell_center), Paragraph("<b>Albireo (β Cyg)</b>", table_cell_style), Paragraph("Cyg", table_cell_style), Paragraph("Double Star", table_cell_style), Paragraph("3.1/5.1", table_cell_center), Paragraph("34.3\"", table_cell_center), Paragraph("73° / 170° (S)", table_cell_style), Paragraph("20mm / 12.5mm", table_cell_style), Paragraph("Chart 2", table_cell_bold)],
        [Paragraph("2", table_cell_center), Paragraph("<b>M22 (NGC 6656)</b>", table_cell_style), Paragraph("Sgr", table_cell_style), Paragraph("Globular Cl.", table_cell_style), Paragraph("5.1", table_cell_center), Paragraph("32.0'", table_cell_center), Paragraph("17.5° / 195° (SSW)", table_cell_style), Paragraph("20mm → 12.5mm", table_cell_style), Paragraph("Full Sky", table_cell_bold)],
        [Paragraph("3", table_cell_center), Paragraph("<b>M13 (Great Globular)</b>", table_cell_style), Paragraph("Her", table_cell_style), Paragraph("Globular Cl.", table_cell_style), Paragraph("5.8", table_cell_center), Paragraph("20.0'", table_cell_center), Paragraph("63.4° / 268° (W)", table_cell_style), Paragraph("12.5mm (96×)", table_cell_style), Paragraph("Chart 3", table_cell_bold)],
        [Paragraph("4", table_cell_center), Paragraph("<b>M92 (NGC 6341)</b>", table_cell_style), Paragraph("Her", table_cell_style), Paragraph("Globular Cl.", table_cell_style), Paragraph("6.3", table_cell_center), Paragraph("14.0'", table_cell_center), Paragraph("71.2° / 295° (WNW)", table_cell_style), Paragraph("12.5mm (96×)", table_cell_style), Paragraph("Chart 3", table_cell_bold)],
        [Paragraph("5", table_cell_center), Paragraph("<b>M11 (Wild Duck)</b>", table_cell_style), Paragraph("Sct", table_cell_style), Paragraph("Open Cluster", table_cell_style), Paragraph("5.8", table_cell_center), Paragraph("14.0'", table_cell_center), Paragraph("35.2° / 205° (SSW)", table_cell_style), Paragraph("20mm & 12.5mm", table_cell_style), Paragraph("Chart 6", table_cell_bold)],
        [Paragraph("6", table_cell_center), Paragraph("<b>M57 (Ring Nebula)</b>", table_cell_style), Paragraph("Lyr", table_cell_style), Paragraph("Planetary Neb.", table_cell_style), Paragraph("8.8", table_cell_center), Paragraph("1.4'×1.0'", table_cell_center), Paragraph("76.1° / 222° (SW)", table_cell_style), Paragraph("12.5mm (96×)", table_cell_style), Paragraph("Chart 1", table_cell_bold)],
        [Paragraph("7", table_cell_center), Paragraph("<b>M27 (Dumbbell)</b>", table_cell_style), Paragraph("Vul", table_cell_style), Paragraph("Planetary Neb.", table_cell_style), Paragraph("7.4", table_cell_center), Paragraph("8.0'×5.6'", table_cell_center), Paragraph("68.2° / 164° (SSE)", table_cell_style), Paragraph("20mm (60×)", table_cell_style), Paragraph("Chart 2", table_cell_bold)],
        [Paragraph("8", table_cell_center), Paragraph("<b>Double Cluster</b>", table_cell_style), Paragraph("Per", table_cell_style), Paragraph("Dual Open Cl.", table_cell_style), Paragraph("3.7/3.8", table_cell_center), Paragraph("60.0'", table_cell_center), Paragraph("34.1° / 038° (NE)", table_cell_style), Paragraph("20mm (60×)", table_cell_style), Paragraph("Chart 5", table_cell_bold)],
        [Paragraph("9", table_cell_center), Paragraph("<b>M31 (Andromeda)</b>", table_cell_style), Paragraph("And", table_cell_style), Paragraph("Spiral Galaxy", table_cell_style), Paragraph("3.4", table_cell_center), Paragraph("190'×60'", table_cell_center), Paragraph("43.5° / 068° (ENE)", table_cell_style), Paragraph("20mm (60×)", table_cell_style), Paragraph("Chart 4", table_cell_bold)],
        [Paragraph("10", table_cell_center), Paragraph("<b>Saturn & Titan</b>", table_cell_style), Paragraph("Aqr", table_cell_style), Paragraph("Planet & Rings", table_cell_style), Paragraph("+0.6", table_cell_center), Paragraph("19.2\"", table_cell_center), Paragraph("18°–23° / 115° (ESE)", table_cell_style), Paragraph("12.5mm (96×)", table_cell_style), Paragraph("Chart 6", table_cell_bold)],
    ]
    t_cat = Table(cat_data, colWidths=[8.5*mm, 33.5*mm, 14*mm, 23*mm, 15*mm, 15*mm, 27*mm, 24*mm, 14*mm])
