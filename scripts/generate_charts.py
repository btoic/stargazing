...
def get_chart_2_dossier(include_hop=True):
    txt = (
        ...
        "• Constellation: Vulpecula / Cygnus | Type: Planetary Nebula & Binary\n"
        "• M27: Mag 7.5V | Surface Brightness: 11.2 mag/arcmin² | Size: 8.0' × 5.6'\n"
...
def get_chart_3_dossier(include_hop=True):
    txt = (
        ...
        "  8-inch Dobsonian, the cluster bursts into hundreds of sparkling\n"
